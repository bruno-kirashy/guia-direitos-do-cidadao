...
const LinkCard = ({ href, title, description, isDarkMode }: LinkCardProps) => (
    <a
      ...
      className={`p-5 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-start gap-4 ${isDarkMode ? 'bg-gray-800 shadow-blue-900/20' : 'bg-white'}`}
    >
        <div className={`p-3 rounded-full ${isDarkMode ? 'bg-gray-700' : 'bg-blue-100'}`}>
...
function App() {
  ...
  // O useEffect que manipulava o DOM foi removido.
    ...
    <div className={`min-h-screen font-sans flex flex-col transition-colors duration-300 ${isDarkMode ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'}`}>
      <main className="container mx-auto px-4 py-8 md:py-16 flex-grow relative">
        ...
        <header className="text-center mb-12 md:mb-16 pt-12">
          <h1 className={`text-4xl md:text-5xl font-extrabold mb-4 ${isDarkMode ? 'text-blue-300' : 'text-blue-900'}`}>
        ...
        <Section>
          ...
          <div className={`max-w-3xl mx-auto rounded-xl shadow-lg ${isDarkMode ? 'bg-gray-800 shadow-blue-900/20' : 'bg-white'}`}>
        ...
        <Section className="text-center">
          <div className={`p-6 rounded-xl max-w-2xl mx-auto shadow-lg flex flex-col sm:flex-row items-center justify-center gap-4 ${isDarkMode ? 'bg-blue-500/20 text-blue-200' : 'bg-blue-800 text-white'}`}>
      ...
      <footer className={`py-6 mt-auto ${isDarkMode ? 'bg-black/50 text-gray-500' : 'bg-gray-800 text-gray-400'}`}>
